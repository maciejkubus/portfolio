export function Footer() {
	return (
		<footer className="container mx-auto px-2 md:px-8 xl:px-12">
			<div className="w-full p-8 bg-black text-white rounded-3xl space-y-8">
				<div className="flex flex-col lg:flex-row gap-8">
					<div className="w-full space-y-8">
						<h3 className="text-4xl xl:text-6xl font-bold">Astoria Star</h3>
						<p className="text-lg">
					...
					<div className="w-full xl:w-2/3 space-y-8">
						<h2 className="text-4xl font-bold xl:mt-6">Informacje</h2>
					...
					<div className="w-full xl:w-2/3 space-y-8">
						<h2 className="text-4xl font-bold xl:mt-6">Linki</h2>
						<div className="text-lg">
