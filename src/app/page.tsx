...
export default function Home() {
  return (
    <main className="container mx-auto px-2 md:px-8 xl:px-12">
      <div className="py-32 w-full flex gap-8">
        <div className="w-1/2">
          ...
          <p className="text-xl my-8">
            ...
            cupiditate facere sequi hic exercitationem nisi rem, tempora
            accusamus aliquid, mollitia suscipit minima neque.
          </p>
          <div className="flex gap-8">
            <button className="bg-primary rounded-xl font-bold px-6 py-3 text-white">
      ...
      <div className="w-full flex gap-8 font-bold text-6xl">
      ...
      <div className="flex justify-center pb-16">
        <button className="bg-primary rounded-xl font-bold px-8 py-4 text-white text-2xl">
