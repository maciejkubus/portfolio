...
export default function Team() {
  ...
  <div className="flex w-full gap-8 text-6xl font-bold mb-4">
    ...
    <div className="flex gap-8 mt-8">
        <div className="rounded-3xl border-2 border-black p-6 shadow-shadow w-1/3">
            <div className='bg-slate-400 rounded-2xl h-80'></div>
        </div>
        <div className="rounded-3xl border-2 border-black p-6 shadow-shadow w-2/3">
